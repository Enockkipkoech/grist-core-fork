...
export class TrivialDocStorageManager implements IDocStorageManager {
  ...
  public getSampleDocPath() {
    return null;
  }
  public async getCanonicalDocName(altDocName: string) {
    return altDocName;
  }
  ...
  public async prepareFork(): Promise<never> {
    throw new Error("no");
  }
  public async listDocs() {
    return [];
  }
  public async deleteDoc(): Promise<never> {
    throw new Error("no");
  }
  public async renameDoc(): Promise<never> {
    throw new Error("no");
  }
  public async makeBackup(): Promise<never> {
    throw new Error("no");
  }
  public async showItemInFolder(): Promise<never> {
    throw new Error("no");
  }
  ...
  public async addToStorage(): Promise<never> {
    throw new Error("no");
  }
  public prepareToCloseStorage() {}
  public async getCopy(): Promise<never> {
    throw new Error("no");
  }
  public async flushDoc() {}
  public async getSnapshots(): Promise<never> {
    throw new Error("no");
  }
